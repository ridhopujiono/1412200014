                        ...
                        <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
                            <div class="nav-outer">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class='<?php echo e((request()->is("utama")) ? "active" : ""); ?> dropdown'> <a href="<?php echo e(url('utama')); ?>">Home</a> </li>




                                    <li class='dropdown'> <a href="<?php echo e(url('product')); ?>">Product</a> </li>
    ...
    <footer id="footer" class="footer color-bg">
                            ...
                            <div class="module-body">
                                <ul class="toggle-footer" style="">
                                    ...
                                    <li class="media">
                                        ...
                                        <div class="media-body"> <span><a href="#">ridhopujiono2@gmail.com</a></span> </div>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="copyright-bar">
            <div class="container">
                ...
                <div class="col-xs-12 col-sm-4 no-padding copyright"><a target="_blank" href="https://www.templateshub.net">Ridho Oslhop</a> </div>
                <div class="col-xs-12 col-sm-4 no-padding">
                    <div class="clearfix payment-methods">
                        <ul>
                            <li><img src="resources/assets/images/payments/1.png" alt=""></li>
                            <li><img src="resources/assets/images/payments/2.png" alt=""></li>
                            <li><img src="resources/assets/images/payments/3.png" alt=""></li>
                            <li><img src="resources/assets/images/payments/4.png" alt=""></li>
                            <li><img src="resources/assets/images/payments/5.png" alt=""></li>
                        </ul>
                    </div>
                    <!-- /.payment-methods -->
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\crud_web\resources\views/template/main.blade.php ENDPATH**/ ?>
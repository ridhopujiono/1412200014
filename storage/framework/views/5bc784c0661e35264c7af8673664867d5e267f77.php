                                                        ...
                                                        <ul class="list-unstyled">
                                                            <li class="add-cart-button btn-group">
                                                                <form action="" method="post">
                                                                    ...
                                                                    <button type="submit" name="add_cart" data-toggle="tooltip" class="btn btn-primary icon" type="button" title="Add Cart"> <i class="fa fa-shopping-cart"></i> </button>
...
<?php echo $__env->make('template/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\crud_web\resources\views/product.blade.php ENDPATH**/ ?>
        ...
        <div id="sidebar" class="active">
            <div class="sidebar-wrapper active">
                <div class="sidebar-header" style="padding-bottom: 0">
                    <div class="d-flex">
                        <div class="logo">
                            <a href="<?php echo e(url('dashboard')); ?>"><img src="<?php echo e(asset('resources/assets/images/logo4.png')); ?>" alt="Logo" srcset="" style="height: 50px; margin-right: 10px">idhoShop</a>
                        </div>
                        <div class="toggler">
...
</html><?php /**PATH C:\xampp\htdocs\crud_web\resources\views/template/admin/main.blade.php ENDPATH**/ ?>
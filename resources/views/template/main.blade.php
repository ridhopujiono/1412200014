...
<head>
   ...
   <!-- fevicon -->
   <link rel="icon" href="{{asset('resources/images/fevicon.png')}}" type="image/gif')}}" />
   <!-- Scrollbar Custom CSS -->
   <link rel="stylesheet" href="{{asset('resources/css/jquery.mCustomScrollbar.min.css')}}">
   <!-- Tweaks for older IEs-->
   <link rel="stylesheet" href="https://netdna.bootstrapcdn.com/font-awesome/4.0.3/{{asset('resources/css/font-awesome.css')}}">
...
<body class="main-layout">
   <!-- loader  -->
   <div class="loader_bg">
      <div class="loader"><img src="{{asset('resources/images/loading.gif')}}" alt="#" /></div>
   </div>
   <!-- end loader -->
   <!-- header -->
   <header>
      ...
      <div class="header-top">
         ...
         <!-- sidebar -->
         <script src="{{asset('resources/js/jquery.mCustomScrollbar.concat.min.js')}}"></script>

      ...
      <div class="container">
         <div class="row d_flex">
            ...
            <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
               <div class="text-img">
                  <figure><img src="{{asset('resources/images/img.png')}}" /></figure>
               </div>
            </div>
         </div>
      </div>
               ...
               <div class="row d_flex">
                  ...
                  <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                     <div class="best_img">
                        ...
                        <figure><img src="{{asset('resources/images/beimg.png')}}"></figure>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="row d_flex">
                  <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                     <div class="best_img croos_rt">
                        <h4>Best Design Of Ring</h4>
                        <figure><img src="{{asset('resources/images/beimg2.png')}}"></figure>
                     </div>
                  </div>
                  <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
               ...
               <div class="row d_flex">
                  ...
                  <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
                     <div class="best_img d_none">
                        <h4>Best Design Of Ring</h4>
                        <figure><img src="{{asset('resources/images/beimg3.png')}}"></figure>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <div class="row">
         ...
         <div class="col-md-4">
            <div class="card" style="">
               <img src="{{url('admin/images/products')}}/{{$d->foto}}" class="card-img-top" alt="...">
               <div class="card-body">
                  <h4>{{$d->nama_produk}}</h4>
                  <h5>Rp. {{$d->harga_produk}}</h5>
                        ...
                        <div class="carousel-caption">
                           <div class="row d_flex">
                              <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 pa_rile">
                                 <div class="img_box">
                                    <i><img src="{{asset('resources/images/icon_1.png')}}" alt="#" /></i>
                                    <figure><img src="{{asset('resources/images/clients.png')}}" alt="#" /></figure>
                                 </div>
                              </div>

                        ...
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <h6 class="font-extrabold mb-0">{{ $data_count['total_produk'] }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <h6 class="font-extrabold mb-0">{{ $data_count['total_pengguna'] }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <h6 class="font-extrabold mb-0">{{ $data_count['total_tersedia'] }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <h6 class="font-extrabold mb-0">{{ $data_count['total_habis'] }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    <p class="card-text">
                                        {{Str::limit($d->deskripsi_produk, 75, '.......')}}
                                    </p>
                                </div>
                            </div>
                        </div>
